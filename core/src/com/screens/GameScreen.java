...
public class GameScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        if (world.getState() == GameWorld.GameState.SOLVED){
            ...
            game.batch.end();
            */
            world.dialog.show(world);
            world.toMenuButton.setVisible(true);
        }

        //some sort of check to go back to main menu
        /*
        if (world.getState() == GameWorld.GameState.SOLVED && Gdx.input.isTouched()){
            System.out.println("should return to main screen");
